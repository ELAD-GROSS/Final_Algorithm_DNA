...
from Improvement.FinalDirectedGraph import *
...
def edge_sets_to_string_list(filtered_edge_sets, vertex_to_index):
    ...
    :param vertex_to_index: A list of edges, where an edge in edge_list[i] means that the edge is from vertex in
    index i in vertices_list
